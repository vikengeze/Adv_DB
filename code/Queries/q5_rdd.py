...
#Join: (movieID, ((genre, name, popularity), (userID, rating)))
#Map: ((genre, userID), (1, name, rating, popularity, name, rating, popularity))
#Reduce: ((genre, userID), (count, maxname, maxrating, popularity, minname, minrating, minpopularity))
#Map: (genre, (userID, #ratings, maxName, maxRating, minName, minRating))
#Reduce: (genre, (maxStats))
